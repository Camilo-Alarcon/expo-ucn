...
function emailFormSubmission()
{
	...
	$to = 'admision@ucn.cl';
	$subject = 'Envío de Formulario contacto EXPO UCN 2014';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Nombre:</b></td><td>' . htmlentities($_REQUEST["custom_U15178"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Mensaje:</b></td><td>' . htmlentities($_REQUEST["custom_U15182"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Colegio / Liceo:</b></td><td>' . htmlentities($_REQUEST["custom_U15170"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Teléfono fijo:</b></td><td>' . htmlentities($_REQUEST["custom_U15174"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Apellido:</b></td><td>' . htmlentities($_REQUEST["custom_U15158"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$headers = 'From: admision@ucn.cl' . PHP_EOL . 'Reply-To: ' . $formEmail . PHP_EOL .'X-Mailer: Adobe Muse 2014.0.30 with PHP/' . phpversion() .'/'. PHP_OS . PHP_EOL . 'Content-type: text/html; charset=utf-8' . PHP_EOL;
